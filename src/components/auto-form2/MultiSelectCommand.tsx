...
export const MultiSelectCommand = memo(({ 
  options, 
  value = [], 
  onChange, 
  ...
  const handleSelect = useCallback((selectedValue: string) => {
    ...
    // Verificar se o array realmente mudou antes de chamar onChange
    if (newValue.length !== value.length || !newValue.every((v, i) => v === value[i])) {
      onChange(newValue);
    }
  }, [value, onChange]);
